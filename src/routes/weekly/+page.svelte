<script lang="ts">
	...
	import { filterWeeklyDataByRegion, getWhoRegionsFromData, loadHistoricalCovidData } from '$lib/services/historical-data-service';
...
<div class="w-full h-24 border-b-2 flex flex-col items-center justify-center">
	<h1 class="text-3xl">Covid 19 Visualizations</h1>
	<p>Number of weekly reported COVID-19 cases per region</p>
</div>
